...
export default function SettingsWidget() {
  ...
  return (
    <>
      ...
      <button
        className="fixed bottom-24 md:bottom-6 right-6 bg-blue-500 text-white p-3 rounded-full shadow-lg hover:bg-blue-500/75 transition flex items-center justify-center"
